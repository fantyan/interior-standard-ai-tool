  ...
  return (
    <>
      ...
      >
        ...
        <span className="inline-block ml-4">请输入室内设计问题</span>
        <kbd
      ...
      <Dialog open={open}>
        <DialogContent className="sm:max-w-[850px] text-black">
          <DialogHeader>
            <DialogTitle>AI 室内设计助手</DialogTitle>
            <DialogDescription>
              我是您的室内设计助手，请输入您想查询的问题
            </DialogDescription>
            <hr />
          ...
          <form onSubmit={handleSubmit}>
            ...
            <DialogFooter>
              <div className="text-xs text-gray-500 mt-4 md:m-0 dark:text-gray-100">
                * 回答由 AI 检索室内设计相关文档后生成，不保证准确率，仅供参考学习！
              </div>
